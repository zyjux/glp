...
EXPERIMENT_DIR="/home/lverhoef/glp/glp_ri/experiments/008_train_on_2015_big_models/"
...
/home/lverhoef/.local/bin/safepython.sh $APPLY_SCRIPT $CFG_FILE $OUT_FILE --data_dir=$DATA_DIR --data_file=$DATA_FILE \
