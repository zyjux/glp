...
if __name__ == "__main__":
    ...
    labels, weights = load_labels(
        Path(args.data_dir, args.data_file), desired_ratio=None
    )
    ...
    dataloader = DataLoader(ds, num_workers=8, batch_size=batch_size, pin_memory=True)
