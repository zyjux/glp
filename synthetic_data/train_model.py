...
cnn_train_ds = Ellipse_Dataset(ds, end_idx=8000, transforms=transform_list)
cnn_valid_ds = Ellipse_Dataset(ds, start_idx=8000)

batch_size = hyperparam_config["batch_size"]
cnn_train_dataloader = DataLoader(cnn_train_ds, num_workers=8, batch_size=batch_size)
